...
namespace MommyDayCare.Server.Migrations
{
    ...
    [Migration("20200505110452_removeduserstorolesid")]
    partial class removeduserstorolesid
    {
            ...
            modelBuilder.Entity("MommyDayCare.Shared.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Birthday = new DateTime(2020, 6, 5, 6, 4, 52, 49, DateTimeKind.Local).AddTicks(8449),
                            Country = "jamaica",
                            ...
                            RegisteredOn = new DateTime(2020, 5, 5, 6, 4, 52, 48, DateTimeKind.Local).AddTicks(6267),
                            Salt = "Irk/0AuJPJABaDmJ5z3pmQ==",
                            Sex = 0,
                            UserSlug = new Guid("6a745453-4812-4de0-b063-8b2f75f4f0a6"),
